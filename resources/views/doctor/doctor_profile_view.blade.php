        ...
        <div class="row">
            <div class="card">
                <div class="card-body">
                                  ...
                                  <h6 class="card-title">Update Doctor profile</h6>
  
                                  <form method="POST" action={{ route('doctor.profile.store') }} class="forms-sample"
                                  enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <img id="showImage" class="wd-80 rounded-circle" src="{{ (!empty($profileData->photo)) ? 
                                            url('upload/doctor_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" 
                                            alt="profile">                                    </div>
