            ...
            <div class="dropdown-menu dropdown-menu-end p-0" aria-labelledby="notificationDropdown">
                <div class="px-3 py-2 d-flex align-items-center justify-content-between border-bottom">
                    @if($notificationCount > 0)
                        ...
                        <a  href="{{ route('usermarkAllred') }}"class="btn btn-danger btn-sm">Mark All Read</a>
                        <a href="{{ route('usernotifications.index') }}">View all</a>
                    @else
                        ...
                        <tbody>
                            @foreach ($notifications as $notification)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('usermarkasred', $notification->id) }}" class="btn btn-danger btn-sm">Mark As Read</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                    ...
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        <div class="mb-3">
                            <img class="wd-80 ht-80 rounded-circle" src="{{ (!empty($profileData->photo)) ? 
                              url('upload/user_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="">
                        </div>
