                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton6">
                            <a class="dropdown-item" href="{{ }}:;"><i data-feather="eye" class="icon-sm me-2"></i> View All </a>
                            <a class="dropdown-item" href="javascript:;"><i data-feather="eye" class="icon-sm me-2"></i> Mark All as Read</a>
                        ...
                        <tbody>
                            @foreach ($notifications as $notification)
                                <tr>
                                    ...
                                    <td><a href="{{ route('usermarkasred', $notification->id)}} " class="btn btn-danger">Mark As Read</a></td>
