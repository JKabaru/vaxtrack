          ...
          <div class="dropdown-menu dropdown-menu-end p-0" aria-labelledby="notificationDropdown">
              <div class="px-3 py-2 d-flex align-items-center justify-content-between border-bottom">
                  @if($notificationCount > 0)
                      ...
                      <a href="{{ route('adminmarkAllred') }}" class="btn btn-danger btn-sm">Mark All Read</a>
                      <a href="{{ route('adminnotifications.index') }}">View all</a>
                  @else
                      ...
                      <tbody>
                          @foreach ($notifications as $notification)
                              <tr>
                                  ...
                                  <td>
                                      <a href="{{ route('adminmarkasred', $notification->id) }}" class="btn btn-danger btn-sm">Mark As Read</a>
                                  </td>
                              </tr>
                          @endforeach
                      </tbody>
