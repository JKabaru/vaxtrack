                  ...
                  <div class="auth-form-wrapper px-4 py-5">
                    ...
                    <form id="myForm" class="forms-sample" method="POST" action="{{ route('login') }}">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="password" class="form-control @error('password') is-invalid @enderror" id="userPassword" autocomplete="current-password" placeholder="Password" 
                      ...
                      <div class="form-check mb-3">
                        ...
                        id="authCheck" name="remember" {{ old('remember') ? 'checked' : '' }}>
                      ...
                      <a href="{{ route('admin.register') }}" class="d-block mt-3 text-muted">Not a user? Sign up</a>
